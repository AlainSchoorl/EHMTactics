...
def save(pop, i):
    ...
    with open(('gen' + str(i) + '.bak.csv'), 'wb') as File:
        writer = csv.writer(File, delimiter=';')
        writer.writerows(pop.getFull())
